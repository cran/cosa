mdes.bcrd4r3 <- function(power = .80, alpha = .05, two.tailed = TRUE,
  ...
  var <- c(r21, r22, r23, r2t4, rho2, rho3, rho4, omega4)
  if(any(var < 0) || any(var > 1) || !is.numeric(var) || length(var) > 8){
  ...
  mdes.out <- list(parms = list(power = power, alpha = alpha, two.tailed = two.tailed,
                                ...
                                rho2 = rho2, rho3 = rho3, rho4 = rho4, omega4 = omega4,
                                r21 = r21, r22 = r22, r23 = r23, r2t4 = r2t4,
                                g4 = g4, p = p, n1 = n1, n2 = n2, n3 = n3, n4 = n4),
                   df = df,
                   sse = sse,
                   mdes = mdes)
  class(mdes.out) <- c("mdes", "bcrd4r3")
  .summary.mdes(mdes.out)
  return(invisible(mdes.out))
}

# example
# mdes.bcrd4r3(rho4 = .05, rho3 = .15, rho2 = .15, omega4 = .50, n1 = 10, n2 = 4, n3 = 4, n4 = 20)

power.bcrd4r3 <- function(es = .25, alpha = .05, two.tailed = TRUE,
                          rhots = NULL, k1 = -6, k2 = 6, dists = "normal",
                          rho2, rho3, rho4, omega4,
                          r21 = 0, r22 = 0, r23 = 0, r2t4 = 0, g4 = 0,
                          p = .50, n1, n2, n3, n4) {
  ...
  power.out <-  list(parms = list(es = es, alpha = alpha, two.tailed = two.tailed,
                     ...
                     sse = sse,
                     power = power)
  class(power.out) <- c("power", "bcrd4r3")
  .summary.power(power.out)
  return(invisible(power.out))
}
# example
# power.bcrd4r3(es = .504, rho4 = .05, rho3 = .15, rho2 = .15, omega4 = .50, n1 = 10, n2 = 4, n3 = 4, n4 = 20)

cosa.bcrd4r3 <- function(cn1 = 0, cn2 = 0, cn3 = 0, cn4 = 0, cost = NULL,
  ...
  cosa.out <- list(parms = list(cn1 = cn1, cn2 = cn2, cn3 = cn3, cn4 = cn4, cost = cost,
                                ...
                                n1 = n1, n2 = n2, n3 = n3, n4 = n4),
                   cosa = cosa)
  class(cosa.out) <- c("cosa", "bcrd4r3")
  .summary.cosa(cosa.out)
  return(invisible(cosa.out))
}
# examples
# unconstrained
# cosa.bcrd4r3(constrain = "power", rho2 = .20, rho3 = .10, rho4 = .05, omega4 = .20)
# constrained
# cosa.bcrd4r3(cn1 = c(10,5), cn2 = c(20,10), cn3 = c(50,25), cn4 = 100, cost = 20000,
#              constrain = "cost", rho2 = .20, rho3 = .10, rho4 = .05, omega4 = .20)
