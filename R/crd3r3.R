mdes.crd3r3 <- function(score = NULL, order = 2, rhots = NULL, k1 = -6, k2 = 6, dists = "normal",
  ...
  sse <- (1/(rate.tp - rate.cc)) * sqrt(d * (rho3 * (1 - r23) / (p * (1 - p) * n3) +
  ...
  mdes.out <- list(parms = list(order = order, dists = score$parms$dists,
                                ...
                                g3 = g3, p = p, rate.tp = rate.tp, rate.cc = rate.cc,
                                n1 = n1, n2 = n2, n3 = n3),
                   df = df,
                   sse = sse,
                   mdes = mdes)
...
mdes.crd3 <- mdes.crd3r3

power.crd3r3 <- function(score = NULL, order = 2, rhots = NULL, k1 = -6, k2 = 6, dists = "normal",
...
power.crd3 <- power.crd3r3

cosa.crd3r3 <- function(score = NULL, order = 2, rhots = NULL,
