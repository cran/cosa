mdes.bcrd3r2 <- function(score = NULL, order = 2, rhots = NULL, k1 = -6, k2 = 6, dists = "normal",
...
power.bcrd3r2 <- function(score = NULL, order = 2, rhots = NULL, k1 = -6, k2 = 6, dists = "normal",
...
cosa.bcrd3r2 <- function(score = NULL, order = 2, rhots = NULL,
