mdes.bcrd3f2 <- function(score = NULL, order = 2, rhots = NULL, k1 = -6, k2 = 6, dists = "normal",
  ...
  sse <- (1/(rate.tp - rate.cc)) * sqrt(d * (rho2 * (1 - r22) / (p * (1 - p) * n3 * n2) +
...
power.bcrd3f2 <- function(score = NULL, order = 2, rhots = NULL, k1 = -6, k2 = 6, dists = "normal",
...
cosa.bcrd3f2 <- function(score = NULL, order = 2, rhots = NULL,
